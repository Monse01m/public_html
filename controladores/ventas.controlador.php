...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			function generarYAbrirPDF($codigoVenta)
{
    // Ruta al archivo ticket-new.php (desde la ubicación actual de ventas.controlador.php)
    $rutaPDF = "extensiones/tcpdf/pdf/ticket-new.php";

    // Agregar el parámetro "codigo" a la URL del archivo ticket-new.php
    $urlPDF = $rutaPDF . "?codigo=" . $codigoVenta;

    // Redireccionar al archivo ticket-new.php para que genere y abra el PDF
    echo '<script>window.open("' . $urlPDF . '", "_blank");</script>';
}
			$tabla = "ventas";
			...
			if($respuesta == "ok"){
				...
				if(isset($_POST["impresion"])){
					...
					// Llamada a la función para generar y abrir el PDF
					generarYAbrirPDF($datos["codigo"]);
