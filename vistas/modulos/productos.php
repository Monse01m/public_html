        ...
        <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="Text" class="form-control input-lg" name="nuevoSucursal"  placeholder="Sucursal" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarSucursal" name="editarSucursal" required>
